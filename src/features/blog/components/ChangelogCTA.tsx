...
export default function ChangelogCTA() {
  return (
    <section className="px-6 mt-12 lg:mt-16">
      <div className="relative overflow-hidden rounded-2xl lg:rounded-3xl bg-gradient-to-br from-gray-900
       via-gray-800 to-black dark:from-gray-950 dark:via-gray-900 dark:to-black shadow-2xl
        border border-gray-800/50 transition-all duration-500 hover:shadow-2xl 
        dark:shadow-[0_10px_30px_-10px_rgba(255,255,255,0.05)] dark:hover:shadow-[0_20px_50px_-12px_rgba(255,255,255,0.08)]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 via-transparent
         to-purple-500/5 animate-pulse pointer-events-none"></div>
        ...
        <div className="relative p-8 md:p-12 lg:p-16 flex flex-col items-center text-center">
          ...
          {/* Main Heading */}
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white max-w-3xl">
            What We Are{" "}
