...
export default function page() {
  ...
  <div className="absolute inset-0 -z-10 hidden dark:block">
    <div className="absolute inset-0 bg-[radial-gradient(circle,#73737340_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_70%,transparent_100%)]" />
  </div>

  {/* گرادیان ملایم در پشت عکس (برای تم روشن و تاریک) */}
  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-gradient-to-r from-primary/10 via-primary/5 to-transparent dark:from-primary/20 dark:via-primary/10 blur-3xl -z-10" />
    ...
    <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-20 items-center">
      ...
      <div className="flex-1 text-center lg:text-left space-y-6 max-w-2xl mx-auto lg:mx-0">
        ...
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto lg:mx-0">
          Over 27 alternatives across 7 categories. Free, open source, and paid.
          Compare and switch with confidence.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
          ...
          <div className="text-center sm:text-left">
            <div className="flex gap-1 justify-center sm:justify-start">
              {[...Array(5)].map((_, i) => (
                <LucideStar key={i} stroke="#F39D0B" fill="#F39D0B" size={18} />
              ))}
            </div>
      ...
      <div className="flex-1 flex justify-center lg:justify-end">
        <div className="relative w-[280px] sm:w-[320px] lg:w-[380px]">
          ...
          <div className="absolute inset-0 rounded-full bg-teal-500/20 dark:bg-teal-400/20 blur-2xl -z-10 transform scale-110" />
