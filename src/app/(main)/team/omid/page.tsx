      ...
      <section className="container m-auto max-w-7xl mt-20 px-6">
        <div className="flex flex-col md:flex-row justify-between ">
          <div className="prose dark:prose-invert md:w-[60%]">
            ...
            <p>
              {" "}
              I'm Omid Bagheri — a web developer who started out with graphic
              design and WordPress, but over time moved toward modern web
              development to build websites that are not just good-looking, but
              also fast, scalable, and professional.{" "}
            </p>{" "}
            <p>
              {" "}
              Right now, I mainly work with Next.js, TypeScript, and Tailwind
              CSS, focusing on clean design, smooth user experience, and solid
              performance. I prefer understanding how things work under the hood
              instead of relying too much on plugins or shortcuts, because I
              care about building projects that are optimized, maintainable, and
              actually feel professional. For me, web development is more than
              just making websites — it’s about creating experiences people
              genuinely enjoy using.
            </p>
          </div>

          <Link href="/blog/my-story" className="md:w-[40%] group">
              ...
              <div className="p-8 border-t-4 border-blue-800 flex flex-col justify-between h-full">
                <div>
                  ...
                  <h2 className="mt-2 text-xl/7 font-bold text-gray-900 dark:text-white line-clamp-3 group-hover:text-blue-400 transition-colors">
                    My Journey Through Iran Education System and Medical Field:
